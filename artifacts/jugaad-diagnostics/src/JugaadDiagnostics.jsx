...
Respond JSON only (no markdown):
{
  ...
  const S = {
    ...
    topBar:{background:"#1a472a",padding:"0 12px",display:"flex",alignItems:"center",justifyContent:"space-between",height:100,position:"sticky",top:0,zIndex:100,flexWrap:"wrap",gap:2},
